# -*- coding: utf-8 -*-
"""
Created on Wed Nov  9 20:56:05 2022
@author: Dell

https://www.geeksforgeeks.org/conways-game-life-python-implementation/

Conways’s Game Of Life is a Cellular Automation Method created by John Conway. 
This game was created with Biology in mind but has been applied in various fields 
such as Graphics, terrain generation,etc..
...
eight neighboring cells, as shown in the given figure. 
A given cell (i, j) in the simulation is accessed on a grid [i][j], 
where i and j are the row and column indices, respectively. 
The value of a given cell at a given instant of time depends on the state of 
its neighbors at the previous time step. Conway’s Game of Life has four rules. 
...
python game-of-life.py --grid-size 32 --interval 500 --glide 
"""
